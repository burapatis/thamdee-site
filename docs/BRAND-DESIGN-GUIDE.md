...
3. Ecosystem       — การ์ด 8 โปรเจกต์ (data-driven) + chip หมวด + audience
4. Apps            — จุดเด่นแอป + 3 checkpoints + disclaimer สุขภาพ + CTA
5. Knowledge Hubs  — การ์ด 5 ศูนย์ความรู้ (hub/teacher/gced/admin/law)
...
Footer: about + tagline | ลิงก์ 8 โปรเจกต์ | ลิงก์กฎหมาย | โซเชียล | copyright + AI note
...
**Signature element:** Orbit Diagram ใน Hero — โหนด 8 โปรเจกต์โคจรรอบแกน "ทำดี" สื่อคำว่า ecosystem เป็นภาพเดียว วงแหวนหมุนช้ามาก (90–150 วินาที/รอบ) และหยุดสนิทเมื่อผู้ใช้ตั้ง reduced motion
...
- **Schema:** Organization + WebSite + ItemList (8 โปรเจกต์) ผ่าน JSON-LD
...
- [ ] ตรวจ URL subdomain ทั้ง 8 ว่าใช้งานได้จริง (รวม law.thamdee.com) (โดยเฉพาะ youtube./tiktok. redirect)
